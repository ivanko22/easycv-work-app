...
<template>
    ...
    <div class="stepTwoForm">
        ...
        <base-wizzard :isRegistered="true" :experience="true" :isExperienced="true"></base-wizzard>

        <base-form v-on:update:jobsList="getListOfJob"/>

        <base-button v-on:update:primaryBtnStatus="primaryBtnStatus" label="Next" :class="{ primaryBtn: isFormValid }" type="submit" />
    </div>
</template>
