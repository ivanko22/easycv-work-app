<template>
    <div @click="openCloseJobAcc" class="jobContainer">
        ...
        <div class="iconsContainer">
            <svg class="iconContainer"  width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg class="iconContainer" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="iconColor" d="M10.7813 2.86274C11.1404 2.50377 11.6274 2.30215 12.1351 2.30225C12.6429 2.30234 13.1298 2.50413 13.4888 2.86324C13.8478 3.22234 14.0494 3.70934 14.0493 4.21709C14.0492 4.72485 13.8474 5.21177 13.4883 5.57074L12.7553 6.30274L10.0463 3.59674L10.7803 2.86274H10.7813ZM9.34128 4.30374L3.38528 10.2577C3.2045 10.4387 3.06824 10.6591 2.98728 10.9017L2.07328 13.6447C2.04408 13.7328 2.03994 13.8272 2.06131 13.9174C2.08268 14.0076 2.12873 14.0901 2.1943 14.1557C2.25987 14.2213 2.34239 14.2673 2.43263 14.2887C2.52286 14.3101 2.61727 14.3059 2.70528 14.2767L5.44828 13.3627C5.69128 13.2827 5.91128 13.1457 6.09228 12.9647L12.0483 7.01074L9.34028 4.30374H9.34128Z" fill="#B3B3B3"/>
            </svg>

            <svg class="iconContainer" :class="{ rotateIconUp: isBaseJobOpen }" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
                 <path class="accordionIconColor" d="M6.14791 16.8218C5.9394 16.6132 5.82227 16.3304 5.82227 16.0355C5.82227 15.7405 5.9394 15.4577 6.14791 15.2491L11.6535 9.74355L6.14791 4.23798C5.94531 4.02821 5.8332 3.74726 5.83574 3.45563C5.83827 3.16401 5.95524 2.88504 6.16146 2.67883C6.36768 2.47261 6.64664 2.35564 6.93827 2.3531C7.22989 2.35057 7.51084 2.46268 7.72061 2.66528L14.0125 8.95719C14.221 9.16577 14.3382 9.44862 14.3382 9.74355C14.3382 10.0385 14.221 10.3213 14.0125 10.5299L7.72061 16.8218C7.51204 17.0303 7.22919 17.1475 6.93426 17.1475C6.63934 17.1475 6.35649 17.0303 6.14791 16.8218Z" fill="black"/>
                </g>
            </svg>
